...
const { BOT_TOKEN, ADMIN_ID, CROSST_PASSWD, CROSST_NICK, CROSST_CHANNEL, LANGUAGE, SMMS_TOKEN } = process.env;
...
export { bot, CrosstWs, ADMIN_ID, CROSST_NICK, CROSST_PASSWD, CROSST_CHANNEL, BOT_NAME, LANGUAGE, BOT_TOKEN, SMMS_TOKEN };
